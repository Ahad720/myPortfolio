...
String yourname = "I'm Abdul Ahad Khan,";
...
const String aboutMeHeadline =
    'I\'m Abdul Ahad Khan, a Mobile App developer and Web developer.';

const String aboutMeDetail =
    'I\'m a Graduate as Software Engineer from Arid Agriculture University, PAKISTAN. and I have done Masters in International Business and Project Management from Ulster University, UK. I have been developing mobile apps for over 4 years now. I have worked in teams for various startups and helped them in launching their prototypes and got valuable learning experience. Been a CEO/Co-Founder of Onyxsio, Sri Lanka. Currently working as an Associate Software Engineer at Onyxsio.';
